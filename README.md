...
- [ ] In the final terminal window, make sure you are in the `client` folder sti
...
- [ ] Add a test file for the `ShoppingCart` component and test that it displays plants there (you'll need some mock plant data for the test, and then you can pass tha data in as a prop when you call `render` and render the component - see the example below)
